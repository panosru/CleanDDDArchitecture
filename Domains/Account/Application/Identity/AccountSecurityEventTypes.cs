...
public static class AccountSecurityEventTypes
{
    ...
    public const string AccountDeletionRequested = nameof(AccountDeletionRequested);
    public const string AccountDeleted = nameof(AccountDeleted);
    public const string AccountReactivated = nameof(AccountReactivated);
    ...
    public const string TrustedDeviceAdded = nameof(TrustedDeviceAdded);
    public const string TrustedDeviceRevoked = nameof(TrustedDeviceRevoked);
    public const string TrustedDevicesRevoked = nameof(TrustedDevicesRevoked);
    public const string PhoneVerificationRequested = nameof(PhoneVerificationRequested);
    public const string PhoneVerified = nameof(PhoneVerified);
    public const string PhoneChanged = nameof(PhoneChanged);
