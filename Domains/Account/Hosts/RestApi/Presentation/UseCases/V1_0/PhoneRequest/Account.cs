...
namespace CleanDDDArchitecture.Domains.Account.Hosts.RestApi.Presentation.UseCases.V1_0.PhoneRequest;
...
public sealed class Account : ApiController<RequestPhoneVerificationUseCase, Account>, IRequestPhoneVerificationOutput
{
    ...
    {
        await UseCase.ExecuteAsync(new RequestPhoneVerificationInput(dto.PhoneNumber, false)).ConfigureAwait(false);
