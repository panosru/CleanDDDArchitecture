...
builder.Services.AddControllers(options =>
    ...
    .AddApplicationPart(typeof(CleanDDDArchitecture.Domains.Todo.SubDomains.TodoItem.Hosts.RestApi.Presentation.ApiController).Assembly)
    .AddApplicationPart(typeof(CleanDDDArchitecture.Domains.Todo.SubDomains.TodoList.Hosts.RestApi.Presentation.ApiController).Assembly);
