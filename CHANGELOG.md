...
- Under Aspire every email job failed to start, because `EmailSettings:EnableSsl` was required and Aspire does not set it. Aviant's new startup job check found it.
