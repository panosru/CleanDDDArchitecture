namespace Aviant.DDD.Application.Event
{
    ...
    using Domain.Events;
    using MediatR;
    using INotification = Domain.Notifications.INotification;

    public abstract class EventEventDispatcherBase : IEventDispatcher
    {
        private readonly IMediator _mediator;

        public EventEventDispatcherBase(IMediator mediator)
        {
            _mediator = mediator;
        }
